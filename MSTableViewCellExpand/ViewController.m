//
//  ViewController.m
//  MSTableViewCellExpand
//
//  Created by niuniu on 15-6-3.
...
#import "MyCell.h"
@interface ViewController ()<MSSTableViewDelegate>

@property (nonatomic, strong) NSArray *contents;
@property (nonatomic, strong) NSMutableArray *selectedDataArr;

@property (nonatomic, strong) MSSTableView *tableView;
@end
...
{
    [super viewDidLoad];
    self.tableView = [[MSSTableView alloc] initWithFrame:self.view.bounds style:UITableViewStyleGrouped];
