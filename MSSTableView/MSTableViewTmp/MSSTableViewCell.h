...
/**
 *  MSSTableViewCell is a custom table view cell class extended from UITableViewCell class. This class is used to represent the
 *  expandable rows of the MSSTableView object.
 */

@interface MSSTableViewCell : UITableViewCell
